  ...
  tagList(
    ...
    navlistPanel(
      ...
      tabPanel("Search database",
               ...
               p(h4("Query builder")),
               p("The user can generate simple or complex queries with the query builder at the left."),
               p(h4("Output format")),
      ...
      tabPanel("Predict traits from genome",
               ...
               tags$ol(class = "circled-list",
                       ...
                       tags$li(downloadLink(outputId = ns("downloadFunctions_2"), label = "Example 2 (cultured prokaryotes of rumen)")),

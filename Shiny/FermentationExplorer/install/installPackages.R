...
# === Install packages ===
  ...
  cran_packages <- cran_packages <- c(
    "ape", "base", "BiocManager", "bslib", "caret", "colorspace", "dplyr", "DT",
    "fbar", "htmltools", "igraph", "import", "jqbr", "jsonlite",
    "magrittr", "plotly", "purrr", "randomForest", "reactlog", "readr",
    "remotes", "rlang", "rsconnect", "shiny", "shinycssloaders", "shinyjs",
    "shinyWidgets", "stats", "stringr", "tidyr", "tidyselect"
  )

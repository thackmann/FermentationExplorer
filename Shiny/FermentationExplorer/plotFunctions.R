...
# --- Plot summary plot ---
  ...
  #' @return A vector of shortened labels.
  #' @export
...
# --- Plot treemap ---
  ...
  #' @param target_length The target length for the string after padding.
  #' @return A padded string with spaces added to reach the target length.
  #' @export
  ...
  pad_to_length <- function(x, target_length = 8) {
    ...
    padded_string <- paste0(strrep(" ", left_padding), x, strrep(" ", right_padding))

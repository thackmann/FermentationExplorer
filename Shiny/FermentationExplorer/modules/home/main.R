  ...
  homeUI <- function(id) {
    ...
    htmltools::tagList(
      ...
      bslib::layout_column_wrap(
        ...
        div(
          home_button(button_name = ns('jump_history'), position = "right", icon_background_color = "#808285", image_name = "history", title = "Prediction history", subtitle = "View past searches and predicitons"),
          align = "left"
        ),
        div(
